...
BUILTIN_MODELS: list[ModelInfo] = [
    ...
    ModelInfo(
        ...
        description="Moonshot Kimi K3 MoE model (native MXFP4 experts, SiTU activation, latent routed-expert MoE)",
        description_zh="月之暗面 Kimi K3 MoE 模型（原生 MXFP4 专家，SiTU 激活，latent 路由专家 MoE）",
    ),
    ModelInfo(
